    ...
    <div class="collection-ui p-3 border-2 border-left-primary rounded bg-white">
        ...
        <div class="d-flex gap-3 mb-3 pb-2 border-bottom">
            ...
            <div class="flex-grow-1">
                ...
                <select v-model="node.collection" class="form-control form-control-sm" @change="fetchChildMeta">
            ...
            <div class="d-flex gap-1 align-items-end">
                <button class="btn btn-xs btn-default" @click="addCondition(node.where, node.alias || 'row')" :title="__('Add Condition')">
                    <i class="fa fa-plus"></i>
                </button>
                <button class="btn btn-xs btn-default" @click="addGroup(node.where)" :title="__('Add Group')">

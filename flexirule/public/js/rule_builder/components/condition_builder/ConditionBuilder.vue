...
provide('docFields', computed(() => props.docFields));
...
<template>
    <div class="condition-builder">
        ...
        <div v-if="!rootGroup.conditions?.length" class="text-muted text-center py-4 border-dashed rounded">

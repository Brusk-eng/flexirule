            ...
            <div class="canvas-container" ref="flowWrapper" @dragover="onDragOver" @drop="onDrop">
                ...
                >
                    ...
                    <Panel :position="PanelPosition.BottomLeft" class="controls-panel">
                         <div class="btn-group">
                            <button class="btn btn-sm btn-default" @click="zoomIn" :title="__('Zoom In')">+</button>
                            <button class="btn btn-sm btn-default" @click="zoomOut" :title="__('Zoom Out')">-</button>
                            <button class="btn btn-sm btn-default" @click="fitView()" :title="__('Fit View')">{{ __("Fit") }}</button>
                         </div>
                ...
                >
                    <div class="toolbar-handle" @dblclick="toggleCollapse">
                        ...
                        <span class="pull-right collapse-btn" @click.stop="toggleCollapse">
                            <i class="fa" :class="isCollapsed ? 'fa-angle-down' : 'fa-angle-up'"></i>
                        </span>
                    </div>
                    <div class="btn-group-vertical" v-show="!isCollapsed">
                        <button class="btn btn-xs btn-default" :draggable="true" @dragstart="onDragStart($event, 'process')" @click="addNode('process')" :title="__('Add Process')">
                            <i class="fa fa-cog"></i> {{ __("Process") }}
                        </button>
                        <button class="btn btn-xs btn-default" :draggable="true" @dragstart="onDragStart($event, 'condition')" @click="addNode('condition')" :title="__('Add Condition')">
                            <i class="fa fa-code-fork"></i> {{ __("Condition") }}
                        </button>
                        <button class="btn btn-xs btn-default" :draggable="true" @dragstart="onDragStart($event, 'loop')" @click="addNode('loop')" :title="__('Add Loop')">
                                <i class="fa fa-refresh"></i> {{ __("Loop") }}
                        </button>
                        <button class="btn btn-xs btn-default" :draggable="true" @dragstart="onDragStart($event, 'switch')" @click="addNode('switch')" :title="__('Add Switch')">
                            <i class="fa fa-code-fork" style="transform: rotate(90deg)"></i> {{ __("Switch") }}
                        </button>
                        <button class="btn btn-xs btn-default" :draggable="true" @dragstart="onDragStart($event, 'wait')" @click="addNode('wait')" :title="__('Add Wait')">
                            <i class="fa fa-clock-o"></i> {{ __("Wait") }}
                        </button>
                        <button class="btn btn-xs btn-default" :draggable="true" @dragstart="onDragStart($event, 'sub-rule')" @click="addNode('sub-rule')" :title="__('Add Sub-Rule')">
                                <i class="fa fa-cube"></i> {{ __("Sub-Rule") }}
                        </button>
                        <button class="btn btn-xs btn-default" :draggable="true" @dragstart="onDragStart($event, 'stop')" @click="addNode('stop')" :title="__('Add Stop')">
...
.small-switch { width: 28px; height: 16px; margin: 0; }

...
export const SLASH_COMMANDS = [
	...
	{
		id: "link",
		label: __("Link Picker"),
		type: "logic",
		icon: "🔗",
		groups: [FORMULA_GROUPS.LINK],
	},
	{
		id: "dynamic-link",
		label: __("Dynamic Link"),
		type: "logic",
		icon: "🧩",
		groups: [FORMULA_GROUPS.LINK],
	},

	...
	<div class="action-settings-container">
		<div class="settings-section">
			...
			<div class="settings-grid">
				<div class="grid-item">
					<ControlFactory
						:df="with_read_only({ fieldname: 'is_enabled', fieldtype: 'Check', label: __('Enabled') })"
				...
				<div class="grid-item">
					<ControlFactory
						:df="with_read_only({ fieldname: 'is_async', fieldtype: 'Check', label: __('Run Asynchronously') })"
				...
				<div class="grid-item">
					<ControlFactory
						:df="with_read_only({ fieldname: 'skip_permissions', fieldtype: 'Check', label: __('Skip Permissions') })"
				...
				<div class="grid-item">
					<ControlFactory
						:df="with_read_only({ fieldname: 'on_error', fieldtype: 'Select', label: __('On Error'), options: 'Stop\nContinue\nRetry\nRaise Error' })"
				...
				<div class="grid-item" v-if="node.data?.on_error === 'Retry'">
					<ControlFactory
						:df="with_read_only({ fieldname: 'retry_count', fieldtype: 'Int', label: __('Retry Count') })"
				...
				<div class="grid-item">
					<ControlFactory
						:df="with_read_only({ fieldname: 'timeout', fieldtype: 'Int', label: __('Timeout (s)') })"
		...
		<div class="settings-section">
			...
			<div class="settings-grid">
				<div class="grid-item span-2">
					<ControlFactory
						:df="with_read_only({ fieldname: 'next_step_if_true', fieldtype: 'Data', label: node.data?.action_type === 'Condition' ? __('Next Step (If True)') : __('Next Step') })"
				...
				<div class="grid-item span-2" v-if="node.data?.action_type === 'Condition'">
					<ControlFactory
						:df="with_read_only({ fieldname: 'next_step_if_false', fieldtype: 'Data', label: __('Next Step (If False)') })"

...
class RuleAction(Document):
	...
	if TYPE_CHECKING:
		...
		action_type: DF.Literal["Entry Action", "Condition", "Process", "Loop", "Stop", "Switch", "Wait", "Sub-Rule", "Set Value", "Raise Error", "Notify", "Query Records", "Aggregate Records", "Create Docs"]

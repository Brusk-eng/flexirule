...
class RuleEngine:
    ...
    def _execute_set_value(self, action, context):
        ...
        # Render Jinja template with restricted frappe access
        template_context = {
            "doc": context.get("doc"),
            "vars": context.get("vars", {}),
            "frappe": SafeFrappeAPI(),  # Use restricted API instead of unrestricted frappe
            "utils": frappe.utils,
        }
    ...
    def _save_execution_log(self, status, duration, error_trace=None, context=None):
        ...
        try:
            ...
            if self.context.get("dry_run"):
                ...
                # Success or Test Mode: Insert as part of current transaction

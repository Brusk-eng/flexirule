...
class TestProcessSync(FrappeTestCase):
    ...
    def setUp(self):
        ...
        processes = frappe.get_all(
            "Process", filters={"process_name": ["like", "Test%"]}, pluck="name"
        )
    ...
    def test_import_process_from_file_update(self):
        ...
        updated_json_path = self.create_test_process_json(
            "TestUpdateProcess", updated_operations
        )
        ...
        self.assertEqual(
            updated_process_doc.operations[0].label, "Updated Test Operation"
        )
    ...
    def test_import_process_from_file_add_operation(self):
        ...
        updated_json_path = self.create_test_process_json(
            "TestAddOpProcess", additional_operations
        )
    ...
    def test_import_process_from_file_with_all_operation_fields(self):
        ...
        json_path = self.create_test_process_json(
            "TestComprehensiveProcess", operations_with_all_fields
        )
        ...
        self.assertEqual(
            operation.reads_vars, '[{"fieldname": "input_var", "fieldtype": "Data"}]'
        )
        self.assertEqual(
            operation.writes_vars, '[{"fieldname": "output_var", "fieldtype": "Data"}]'
        )
        self.assertEqual(

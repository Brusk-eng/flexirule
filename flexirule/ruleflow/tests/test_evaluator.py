...
class TestConditionEvaluator(FrappeTestCase):
    ...
    def test_evaluate_in_condition_true(self):
        ...
        conditions_json = '[{"left": {"ref": "doc.status"}, "op": "in", "right": {"value": ["Open", "Closed"]}}]'
        evaluator = ConditionEvaluator(conditions_json)
    ...
    def test_evaluate_not_in_condition_false(self):
        ...
        conditions_json = '[{"left": {"ref": "doc.status"}, "op": "not_in", "right": {"value": ["Open", "Closed"]}}]'
        evaluator = ConditionEvaluator(conditions_json)
    ...
    def test_evaluate_contains_condition_true(self):
        ...
        conditions_json = '[{"left": {"ref": "doc.description"}, "op": "contains", "right": {"value": "description"}}]'
        evaluator = ConditionEvaluator(conditions_json)
    ...
    def test_evaluate_regex_condition_true(self):
        ...
        conditions_json = '[{"left": {"ref": "doc.description"}, "op": "regex", "right": {"value": "^Test.*on$"}}]'
        evaluator = ConditionEvaluator(conditions_json)
    ...
    def test_evaluate_with_old_doc(self):
        ...
        conditions_json = '[{"left": {"ref": "old_doc.description"}, "op": "==", "right": {"value": "Original"}}]'
        evaluator = ConditionEvaluator(conditions_json)
    ...
    def test_check_link_match_false(self):
        ...
        self.assertFalse(
            check_link_match("User", ["DocType", ["Task", "User"]], "not in")
        )
